...
class Estimator(object):
    def __init__(self, model_path="./model/a2c_22.pth", step_time=60):
        # model parameters
        state_dim = 4
        action_dim = 1
        ...
        self.model = A2C(state_dim, action_dim).to(self.device)
        checkpoint = torch.load(model_path)
        self.model.actor_critic.load_state_dict(checkpoint['net'])
